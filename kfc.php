...
<body>
    ...
    <div style="display: flex; padding: 15px;">
        ...
        <div style="padding-top: 55px; padding-left: 5px;">
            <h2>KFC</h2>
            <h4>Американська мережа ресторанів швидкого харчування, що спеціалізуються на стравах із курятини. Заснована в 1952</h4>
        </div>
    </div>
  

    <h3 style="margin-left: 15px; margin-top:5px;">Популярне:</h3>

    <section class="rests salad">    
    <?php 
            $query ="SELECT * FROM food WHERE type = 'shaurma' and rest = 'vlavashe'";
    ...
    <h3 style="margin-left: 15px; margin-top:5px;">King-Size:</h3>

    <section class="rests salad">    
    <?php 
            $query ="SELECT * FROM food WHERE type = 'shaurmaKing' and rest = 'vlavashe'";
            $result=mysqli_query($link, $query);
            while($row = $result ->fetch_assoc())
            {
                echo '
    ...
    <h3 style="margin-left: 15px; margin-top:5px;">Бургери:</h3>

<section class="rests salad">    
<?php 
        $query ="SELECT * FROM food WHERE type = 'burger' and rest = 'vlavashe'";
        $result=mysqli_query($link, $query);
        while($row = $result ->fetch_assoc())
        {
            echo '
