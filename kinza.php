...
<body>
    ...
    <div style="display: flex; padding: 15px;">
        <img src="/img/kenza.jpg" alt="">
        <div style="padding-top: 55px; padding-left: 5px;">
            <h2>KINZA</h2>
            <h4>Kinza - перший сучасний грузинський ресторан</h4>
        </div>
    </div>
  

    <h3 style="margin-left: 15px; margin-top:5px;">Хачапурі:</h3>

    <section class="rests salad">    
    <?php 
            $query ="SELECT * FROM food WHERE type = 'khachapuri' and rest = 'kinza'";
