...
<body>
    ...
    <div style="display: flex; padding: 15px;">
        <img src="/img/lou-lou.png" alt="">
        <div style="padding-top: 55px; padding-left: 5px;">
            <h2>Lou-Lou</h2>
            <h4>"Бістро з атмосферою свободи та la provocation"</h4>
        </div>
    </div>
  

    <h3 style="margin-left: 15px; margin-top:5px;">Основні страви:</h3>

    <section class="rests salad">    
    <?php 
            $query ="SELECT * FROM food WHERE type = 'second' and rest = 'lou-lou'";
    ...
    <h3 style="margin-left: 15px; margin-top:5px;">Супи:</h3>

    <section class="rests salad">    
    <?php 
            $query ="SELECT * FROM food WHERE type = 'first' and rest = 'lou-lou'";
            $result=mysqli_query($link, $query);
            while($row = $result ->fetch_assoc())
            {
                echo '
...
<section class="rests salad">    
<?php 
        $query ="SELECT * FROM food WHERE type = 'salad' and rest = 'lou-lou'";
        $result=mysqli_query($link, $query);
        while($row = $result ->fetch_assoc())
        {
            echo '
