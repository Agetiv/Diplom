...
<body>
    ...
    <div style="padding-top: 15px; padding-left: 5px;">
            <h2>Рулетка</h2>
            <h4>Не знаеш що обрати? Обирай випадково!</h4>
        </div>

    <section class="rests" style="height: 400px; display:grid">
        ...
        <div >
            <form action="" class="" method="POST">
                <p><input type="submit" class="butn" style="margin-left: 30px;" name="make" value="Згенерувати"></p>
            </form>
        </div>
